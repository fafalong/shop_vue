<template>
    <div class="order">
        ...
        <section class="order-info">
            ...
            <button class="pay-order" @click="goPayment" v-if="orderInfo.status === 10">去支付</button>
            <button class="cancel-order" @click="cancelOrder" v-if="orderInfo.status === 10">取消订单</button>
        </section>
